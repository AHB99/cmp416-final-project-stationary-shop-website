...
import Beans.MonthlyRevenueExpense;
 ...
 * @author azada
 */
@WebServlet(name = "GetMonthlyProfitGraphData", urlPatterns = {"/GetMonthlyProfitGraphData"})
public class GetMonthlyProfitGraphData extends HttpServlet {
